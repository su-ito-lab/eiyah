...
use crate::transaction::{
    ...
    decode_backup_index_entry, encode_backup_index_entry, read_backup_index,
};
...
pub fn restore_home_backups(paths: &ResolvedPaths, home: &Path) -> Result<()> {
...
mod tests {
    ...
    use crate::transaction::write_backup_index;
